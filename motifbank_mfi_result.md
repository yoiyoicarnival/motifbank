...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  2x2x2             768   14,690  (768+4748+9174)   282    52x  ← bank 飽和
  4x2x2           1,536   29,690                    282   105x

  ※ QC_naive = モノマー + ペア + トリマー QC 計算回数
  ※ QC_bank  = 282 (MIC 修正後: 1x1x1 から即飽和)
  ※ MIC 修正により N_bank: 644 → 282 (全モノマーが同一テトラヘドロン, um=1)
  ※ speedup は N に比例: N=10,000 で推定 851x
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  ※ MIC 修正 (PBC 対応) により N_bank: 644 → 282 (speedup 約 2 倍改善)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → bank に貯めるべき fragment エネルギーは有限個 (282 型) で打ち止め。

  内訳 (MIC 修正後):
    um = 1   (全モノマーが同一正四面体 Si(OH)4)
    up = 93  (unique ペア)
    ut = 188 (unique トリマー)

  MotifBank の speedup = (系のサイズ) / (bank の型数)
                       = N / 282    ← N に比例して成長
                       = N=768 で 52x,  N=10,000 で 851x
